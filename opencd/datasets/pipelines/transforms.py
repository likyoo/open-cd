...
class MultiImgExchangeTime(object):
    ...
    def __call__(self, results):
        ...
        if exchange:
            ...
            if 'gt_semantic_seg_from' in results['seg_fields'] and \
                'gt_semantic_seg_to' in results['seg_fields']:
                results['gt_semantic_seg_from'], results['gt_semantic_seg_to'] = \
                    results['gt_semantic_seg_to'], results['gt_semantic_seg_from']
        return results
