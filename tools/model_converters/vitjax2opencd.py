...
def vit_jax_to_torch(jax_weights, num_layer=12):
    ...
    # torch_weights['patch_embed.projection.bias.ln_pre'] = jax_weights[
    #     'embedding/bias/ln1']
    ...
    torch_weights['ln_pre.weight'] = jax_weights['Transformer/encoder_norm/scale']
    torch_weights['ln_pre.bias'] = jax_weights['Transformer/encoder_norm/bias']
