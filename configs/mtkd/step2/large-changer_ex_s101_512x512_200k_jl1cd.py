_base_ = './small-changer_ex_s50_512x512_200k_jl1cd.py'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='train_l/label',
            img_path_from='train_l/A', 
            img_path_to='train_l/B'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='val_l/label',
            img_path_from='val_l/A',
            img_path_to='val_l/B'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='test_l/label',
            img_path_from='test_l/A',
            img_path_to='test_l/B'),
        pipeline=test_pipeline))
